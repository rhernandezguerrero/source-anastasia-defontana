...
import pytest
from source_defontana.source import DefontanaStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DefontanaStream, "path", "v0/example_endpoint")
    mocker.patch.object(DefontanaStream, "primary_key", "test_primary_key")
    mocker.patch.object(DefontanaStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = DefontanaStream()
